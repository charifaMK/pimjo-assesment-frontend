...
// props interface for oauth buttons
  ...
  return (
    <>
      <button
        ...
        disabled={isLoading}
        className="w-full bg-white hover:bg-gray-50 text-gray-900 font-medium py-3 px-4 rounded-4xl flex items-center justify-center gap-2 mb-3 transition disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <svg width="20px" height="20px" viewBox="0 0 256 262" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
          <g>
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full bg-white hover:bg-gray-50 border border-gray-300 text-gray-900 font-medium py-3 px-4 rounded-4xl flex items-center justify-center gap-2 mb-4 transition disabled:opacity-50 disabled:cursor-not-allowed"
      >
